...
admin.site.site_header = "Niko"
admin.site.site_title = "Niko Admin Portal"
admin.site.index_title = "Niko Admin"

# swagger
api_info = openapi.Info(
    title="Niko API",
    default_version="v1",
    description="API documentation for Niko App",
)
